...
**个性化**
- 主题三态(跟随系统 / 浅 / 深),首页刊头与阅读「设置」弹层均可切换,
  深色全量适配;字号四档点选,重排不丢进度
- 章/书海报跟随当前主题生成(深 / 浅两套色板),扫码直达首页或对应章节
...
utils/poster.js                海报 canvas(章/书两级;二维码统一由站点
                               按级生成(/api/mp/v1/qrcode),本地官方码兜底)
