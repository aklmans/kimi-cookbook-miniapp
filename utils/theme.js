...
export function readerTagStyle(theme, fontLarge) {
  ...
  return {
    h1: `font-family:${serif};font-size:${h1}px;font-weight:600;line-height:1.35;margin:0 0 16px;color:${ink}`,
    h2: `font-family:${serif};font-size:${h2}px;font-weight:600;line-height:1.4;margin:44px 0 18px;color:${ink}`,
    h3: `font-family:${serif};font-size:${Math.round(h2 * 0.86)}px;font-weight:600;line-height:1.45;margin:32px 0 12px;color:${ink}`,
    h4: `font-family:${serif};font-size:1em;font-weight:600;margin:24px 0 8px;color:${ink}`,
    ...
    blockquote: `margin:24px 0;padding:12px 18px;border-left:2px solid #1783ff;background:${codeBg};color:${ink2}`,
    ...
    li: `margin:6px 0`,
    dl: `margin:0 0 20px`,
    dt: `font-weight:600;color:${ink};margin-top:12px`,
